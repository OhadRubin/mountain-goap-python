...
from typing import Any, Dict, List, Optional, Iterable, Callable, TypeVar
...
EvaluatedActionNodeEvent = Callable[[Any, Dict[Any, Any]], None]
...
class PermutationSelectorGenerators:
    @staticmethod
    def select_from_collection(values: Iterable[Any]) -> PermutationSelectorCallback:
